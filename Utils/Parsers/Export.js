...
function ExportText(Context) {
	...
	*/
	...
	output.push('This file has been generated by FBI - https://www.notfbi.dev');
	output.push('You can verify the integrity of this export with /verify and the ID above\n');
...
function ExportJSON(Context) {
	const output = {
		export: {
			id: Context.ID,
			warning: `
This export has been generated by FBI : https://www.notfbi.dev/
You can verify the integrity of this export with /verify and the ID above
It will alert you if this file has been edited in any way`.trim()
		},
		guild: Context.Guild,
...
<body>
	...
	<p>
		Export ID: <strong>${Context.ID}</strong> <br>
		This file has been generated by FBI - <a href="https://www.notfbi.dev">https://www.notfbi.dev</a> <br>
		You can verify the integrity of this export with /verify and the ID above
	</p>
    <div id="messages"></div>
